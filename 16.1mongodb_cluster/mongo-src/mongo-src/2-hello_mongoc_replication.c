//2-hello_mongoc_replication.c
/* gcc -o 2-hello_mongoc_replication 2-hello_mongoc_replication.c \
...
int main(int argc, char *argv[])
{
   ...
   "mongodb://localhost:28017,localhost:28018,localhost:28019/?replicaSet=rs0"; // 连接默认的地址
    ...
    */
   database = mongoc_client_get_database(client, "test"); // 创建db
   collection = mongoc_client_get_collection(client, "test", "col");
   ...
   insert = BCON_NEW("name", BCON_UTF8("柚子老师")); // 组装一个json对象
                                                   // 插入到集合
