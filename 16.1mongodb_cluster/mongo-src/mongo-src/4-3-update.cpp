...
// g++ --std=c++17 4-3-update.cpp -o 4-3-update $(pkg-config --cflags --libs libmongocxx)
int main(int, char**) {
    ...
    auto db = conn["test"];
    std::cout << "\n1-Update top-level fields in a single document." << std::endl;
    ...
    std::cout << "\n2-Update an embedded document in a single document." << std::endl;
    ...
    std::cout << "\n3-Update multiple documents." << std::endl;
    ...
    std::cout << "\n4-Replace the contents of a single document." << std::endl;
